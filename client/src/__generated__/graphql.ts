...
export type NewsLikeQueryVariables = Exact<{
  newsId: Scalars['UUID']['input'];
}>;


export type NewsLikeQuery = { __typename?: 'Query', newsLike: { __typename?: 'NewsLikeQuery', findCountByNewsId: number } };
...
export const NewsLikeDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"NewsLike"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"newsId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"newsLike"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"findCountByNewsId"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"newsId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"newsId"}}}]}]}}]}}]} as unknown as DocumentNode<NewsLikeQuery, NewsLikeQueryVariables>;
