...
export type NewsLikeQuery = {
  ...
  findCountByNewsId: Scalars['Int']['output'];
};
...
export type NewsLikeQueryFindCountByNewsIdArgs = {
  newsId: Scalars['UUID']['input'];
};
...
export type LikeMutation = { __typename?: 'Mutation', newsLike: { __typename?: 'NewsLikeMutation', like?: { __typename?: 'NewsLikeGqlModel', newsLikeId: any } | null } };

export type NewsLikeFindCountQueryVariables = Exact<{
  newsId: Scalars['UUID']['input'];
}>;


export type NewsLikeFindCountQuery = { __typename?: 'Query', newsLike: { __typename?: 'NewsLikeQuery', findCountByNewsId: number } };

export type NewsLikeFindByUserIdQueryVariables = Exact<{
  data: NewsLikeFindByUserId;
}>;


export type NewsLikeFindByUserIdQuery = { __typename?: 'Query', newsLike: { __typename?: 'NewsLikeQuery', findByUserId?: { __typename?: 'NewsLikeGqlModel', newsId: any } | null } };
...
export const LikeDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"Like"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"newsId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"newsLike"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"like"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"newsId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"newsId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"newsLikeId"}}]}}]}}]}}]} as unknown as DocumentNode<LikeMutation, LikeMutationVariables>;
export const NewsLikeFindCountDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"NewsLikeFindCount"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"newsId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"newsLike"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"findCountByNewsId"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"newsId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"newsId"}}}]}]}}]}}]} as unknown as DocumentNode<NewsLikeFindCountQuery, NewsLikeFindCountQueryVariables>;
export const NewsLikeFindByUserIdDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"NewsLikeFindByUserId"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"data"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"NewsLikeFindByUserId"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"newsLike"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"findByUserId"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"data"},"value":{"kind":"Variable","name":{"kind":"Name","value":"data"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"newsId"}}]}}]}}]}}]} as unknown as DocumentNode<NewsLikeFindByUserIdQuery, NewsLikeFindByUserIdQueryVariables>;
